            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {
                    values.isLoading ? (
                        <React.Fragment>
                            <div className="relative animate-pulse h-auto bg-gray-50 dark:bg-gray-900 px-6 py-4 rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24 flex flex-col gap-4 p-10 overflow-hidden border border-gray-300 dark:border-gray-600">
                                <div
                                    className='flex flex-col gap-2'
                                >
                                    <div className="h-3 bg-gray-200 rounded-xl dark:bg-gray-700 w-60 max-w-full"></div>
                                    <div className="h-5 bg-gray-200 rounded-xl dark:bg-gray-700 w-64 max-w-full"></div>
                                </div>
                                <div className="h-3 bg-gray-200 rounded-xl dark:bg-gray-700 w-48 max-w-full"></div>
                                <div
                                    className='flex flex-row gap-2 justify-start items-end flex-wrap'
                                >
                                    <div className='w-16 h-16 flex justify-center items-center rounded-xl bg-gray-100 dark:bg-gray-800 overflow-hidden text-gray-400 dark:text-gray-400'>
                                        <div
                                    ...
                                    <div
                                        className='flex flex-row gap-2 justify-start items-end flex-wrap'
                                    >
                                        <div className="h-10 bg-gray-200 rounded-xl dark:bg-gray-700 w-32"></div>
                                        <div className="h-10 bg-gray-200 rounded-xl dark:bg-gray-700 w-16"></div>
                                    </div>
                                </div>
                                <div className="h-3 bg-gray-200 rounded-xl dark:bg-gray-700 w-60 max-w-full"></div>
                                <div
                                    className='flex flex-row gap-2 justify-start items-end flex-wrap'
                                >
                                    <div className="h-5 bg-gray-200 rounded-xl dark:bg-gray-700 w-5"></div>
                                    <div className="h-5 bg-gray-200 rounded-xl dark:bg-gray-700 w-32"></div>
                                </div>
                            </div>
                        </React.Fragment>
                    ) : (
                        <React.Fragment>
                            <div className="relative h-auto bg-gray-50 dark:bg-gray-900 px-6 py-4 rounded-3xl sm:px-16 lg:flex lg:gap-x-20 lg:px-24 flex flex-col gap-4 p-10 overflow-hidden border border-gray-300 dark:border-gray-600">
                                <div className='w-full relative flex flex-col gap-4'>
                                    ...
                                    >
                                        <p
                                            className='flex items-center gap-2 text-gray-400 dark:text-gray-400 text-sm font-bold tracking-tight sm:text-md'
                                        >
                                            {
                                ...
                                dark:bg-red-900 dark:text-red-300 dark:ring-red-300/10">
                                    ...
                                    >
                                        <span
                                            className='text-gray-400 dark:text-gray-400 text-sm font-bold tracking-tight sm:text-md flex flex-col justify-start items-start gap-2'
                                        >
                                            <Image
                                                ...
                                                className='w-16 h-16 flex justify-center items-center rounded-xl bg-gray-100 dark:bg-gray-800 overflow-hidden'
                                            />
                                        </span>
                                        <span
                                            className='font-bold'
                                    ...
                                    <p
                                        ...
                                        dark:text-gray-400 text-gray-400 font-normal sm:text-md
                                        '
                                    >
                ...
                !values.isLoading ?
                    (
                        <React.Fragment>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 grid-flow-row-dense">
                                {/* Humidity */}
                                <div
                                    className="relative min-w-full w-full flex-1 bg-gray-50 dark:bg-gray-900 px-6 py-4 rounded-3xl sm:px-16 lg:flex lg:px-24 gap-4 overflow-hidden border border-gray-300 dark:border-gray-600 h-auto flex flex-row flex-wrap p-6 mx-auto max-w-full text-left justify-start items-end text-gray-900 xl:p-8"
                                >
                                    <div className='w-16 h-16 flex justify-center items-center rounded-xl bg-gray-100 dark:bg-gray-800 overflow-hidden text-gray-400 dark:text-gray-400'>
                                        <Drop
                                            className='h-10 w-10'
                                    ...
                                    >
                                        <p
                                            className='text-gray-400 dark:text-gray-400 text-sm font-bold tracking-tight sm:text-md'
                                        >
                                            Humidity
                                        </p>
                                        <h1
                                            className='text-3xl tracking-tight flex gap-4 justify-start items-end text-gray-900 dark:text-gray-50'
                                        >
                                            <span
                                                className='font-bold'
                                            >
                    ...
                    (
                        <React.Fragment>
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 grid-flow-row-dense">
                                <div
                                    className="relative animate-pulse min-w-full w-full flex-1 bg-gray-50 dark:bg-gray-900 px-6 py-4 rounded-3xl sm:px-16 lg:flex lg:px-24 gap-4 overflow-hidden border border-gray-300 dark:border-gray-600 h-auto flex flex-row flex-wrap p-6 mx-auto max-w-full text-left justify-start items-end text-gray-900 xl:p-8"
                                >
                                    <div className='w-16 h-16 flex justify-center items-center rounded-xl bg-gray-100 dark:bg-gray-800 overflow-hidden text-gray-400 dark:text-gray-400'>
                                        <div
                                            className='h-10 w-10 bg-gray-200 rounded-full dark:bg-gray-700'
                                    ...
                                    <div
                                        className='flex flex-col gap-2'
                                    >
                                        <div className="h-2 bg-gray-200 rounded-xl dark:bg-gray-700 w-16"></div>
                                        <div className="h-10 bg-gray-200 rounded-xl dark:bg-gray-700 w-32"></div>
                                    </div>
                                </div>
                                <div
