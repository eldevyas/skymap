    ...
    return (
        <main className="grid min-h-full place-items-center w-full px-6 py-24 sm:py-32 lg:px-8">
            <div className="text-center max-w-xs md:max-w-xl">
                ...
                {/* <hr className="w-48 h-1 mx-auto my-2 bg-gray-500 border-0 rounded md:my-10 dark:bg-slate-300/25" /> */}
                ...
                <div className="relative mt-6 bg-slate-50 dark:bg-slate-950 rounded-md p-4 w-full border overflow-hidden  border-slate-300 dark:border-slate-700">
                    <code
                    ...
                    "
                    >
                        <span className="text-slate-500">{error.name}:</span>{" "}
                        {error.message}
                        {"."}
                    </code>
                </div>
