...
export default function Home() {
    return (
        <div className="w-full flex flex-col gap-4">
            {/* NavBar  */}
            <NavBar />
            <div className="mx-auto w-full max-w-7xl py-4 sm:py-4 h-full relative overflow-hidden bg-slate-50 dark:bg-slate-800 px-6 pt-16 rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
