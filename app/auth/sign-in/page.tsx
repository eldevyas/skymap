    ...
    return (
        <div
            className={`${isLoading && "animate-bounce"
                } relative flex justify-center items-center h-16 w-16 aspect-square mb-2 p-1 bg-slate-50 border border-slate-200 rounded-3xl shadow-2xl dark:bg-slate-800 dark:border-slate-700 select-none cursor-pointer`}
            onClick={() => Router.push("/")}
        >
            <Image
                src="/favicon.png"
        ...
        <div className="flex flex-col items-center justify-center p-5 mx-auto h-auto lg:py-0 gap-2">
            ...
            <div className="flex flex-col justify-center items-center w-full max-w-lg gap-5">
                ...
                <div className="inline-flex items-center justify-center w-full">
                    ...
                    <span className="absolute px-3 font-medium text-slate-900 -translate-x-1/2 bg-slate-100 left-1/2 dark:text-white dark:bg-slate-900 transition-all duration-500">
                        or
                    </span>
                </div>
                <form
                ...
                >
                    <div className="w-full">
                        ...
                        <input
                            ...
                            name="email"
                            id="email"
                            className="bg-slate-50 border border-slate-300 text-slate-900 text-sm rounded-3xl focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-slate-800 dark:border-slate-600 dark:placeholder-slate-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500 dark:focus:outline-sky-500"
                        ...
                        <div className="flex items-start">
                            <div className="flex items-center h-5">
                                <input
                                    ...
                                    type="checkbox"
                                    className="w-4 h-4 text-sky-600 bg-slate-100 border-slate-300 rounded focus:ring-sky-500 dark:focus:ring-sky-600 dark:ring-offset-slate-800 focus:ring-2 dark:bg-slate-800 dark:border-slate-800"
                                    required={false}
                                />
                            </div>
